...
const COMPANION_DECK = [
  ...
  },
  {
    ...
    category_si: "කාබනික රසායනය",
    title_si: "කාබනික රසායනික ප්‍රතික්‍රියා හා ප්‍රධාන පරීක්ෂණ",
    items: [
      { key: "කාබොනිල් සංයෝග", val: "2,4-DNPH සමඟ තැඹිලි/රතු අවක්ෂේපයක් සාදයි 🟧" },
      { key: "Fehling පරීක්ෂණය", val: "ඇල්ඩිහයිඩ Cu₂O රතු අවක්ෂේපය සාදයි, කීටෝන පරීක්ෂාව නොදක්වයි 🟥" },
      { key: "Tollens පරීක්ෂණය", val: "ඇල්ඩිහයිඩ සමඟ බීකර බිත්තිය මත දිදුලන රිදී කැඩපත (Silver Mirror) සාදයි 🥈" },
      { key: "Lucas පරීක්ෂණය", val: "තෘතියික ඇල්කොහොල සමඟ ක්ෂණිකව බොඳවීම (Cloudiness) ලබාදේ 🧪" },
      { key: "වයිනයිල් හැලයිඩ", val: "අනුරූප බන්ධන ස්ථායීතාව නිසා සාමාන්‍යයෙන් නියුක්ලියෝෆිලික ආදේශ පෙන්වන්නේ නැත" }
    ]
  },
  {
    category: "CHEMICAL BONDING",
    category_si: "රසායනික බන්ධන",
    title_si: "අණුක හැඩයන්, මුහුම්කරණය සහ බන්ධන කෝණ",
    items: [
      { key: "XeF₄ අණුවේ හැඩය", val: "සමතල චතුරස්‍රාකාර (Square Planar) | sp³d² මුහුම්කරණය" },
      { key: "SF₄ අණුවේ හැඩය", val: "දෝලන හැඩය (See-saw) | sp³d මුහුම්කරණය" },
      { key: "I₃⁻ අයනයේ හැඩය", val: "රේඛීය හැඩය (Linear) | sp³d මුහුම්කරණය" },
      { key: "NH₃ බන්ධන කෝණය", val: "107° (තනි යුගල විකර්ෂණය නිසා 109.5° සිට අඩුවේ)" },
      { key: "H₂O බන්ධන කෝණය", val: "104.5° (තනි යුගල දෙකක් අතර පවතින උපරිම විකර්ෂණය නිසා)" }
    ]
  },
  {
    category: "CHEMICAL KINETICS",
    category_si: "චාලක රසායනය",
    title_si: "ප්‍රතික්‍රියා ශීඝ්‍රතාව සහ සක්‍රියන ශක්තිය",
    items: [
      { key: "ප්‍රතික්‍රියා අනුපිළිවෙල", val: "පරීක්ෂණාත්මකව පමණක් තීරණය කළ හැක, සාමාන්‍යයෙන් භාග සංඛ්‍යාද විය හැක" },
      { key: "ශීඝ්‍රතා නියතය (k)", val: "උෂ්ණත්වය මත පමණක් රඳා පවතී, ආරම්භක සාන්ද්‍රණවලින් ස්වායත්ත වේ" },
      { key: "සක්‍රියන ශක්තිය (Ea)", val: "උත්ප්‍රේරක මඟින් අඩු කරනු ලබයි, උෂ්ණත්වය නිසා වෙනස් නොවේ" },
      { key: "කාර්යක්ෂම ගැටුම්", val: "ප්‍රමාණවත් චලිත ශක්තියක් මෙන්ම ගැටෙන මොහොතේ නිවැරදි දිශානතියක් තිබීම අත්‍යවශ්‍යයි" }
    ]
  },
  {
    category: "EQUILIBRIUM",
    category_si: "සමතුලිතතාව",
    title_si: "රසායනික, අයනික, කලාප සහ ද්‍රව-වාෂ්ප සමතුලිතතාවය",
    items: [
      { key: "ලෙ චැටලියර් මූලධර්මය", val: "බාහිර බලපෑමක් ඇතිකළ විට එය අවම වන දිශාවට සමතුලිතතාව විතැන් වේ 🔄" },
      { key: "Kc / Kp නියතයන්", val: "වෙනස් වන්නේ පද්ධතියේ උෂ්ණත්වය වෙනස් කිරීමෙන් පමණි" },
      { key: "ද්‍රාව්‍යතා ගුණිතය (Ksp)", val: "සංතෘප්ත ද්‍රාවණයක ඇති කැටායන/ඇනායන සාන්ද්‍රණවල ගුණිතයයි" },
      { key: "ස්වාරක්ෂක ද්‍රාවණ", val: "දුබල අම්ලයක් හා එම අම්ලයේ ප්‍රබල ලුණු පවතී (pH වෙනස්වීමට ප්‍රතිරෝධය දක්වයි)" },
      { key: "භාගික ආසවනය", val: "රාවුල් නියමයට එකඟ වන පරිපූර්ණ ද්‍රාවණ සඳහා උෂ්ණත්ව-සංයුති කලාප සමතුලිතතාව" }
    ]
  },
  {
    category: "THERMOCHEMISTRY",
    category_si: "එන්තැල්පිය / තාප රසායනය",
    title_si: "එන්තැල්පි වෙනස්වීම් සහ හෙස්ගේ නියමය",
    items: [
      { key: "හෙස්ගේ නියමය", val: "ප්‍රතික්‍රියාවක මුළු ප්‍රතික්‍රියා තාපය මාර්ගයෙන් ස්වායත්ත වේ (ආරම්භක හා අවසාන මත පමණි) ⚖️" },
      { key: "සම්මත උත්පාදන එන්තැල්පිය", val: "ස්වාභාවික මූලද්‍රව්‍යවල සම්මත බහුරූපී ආකාර සඳහා සෑමවිටම ශුන්‍ය (0) වේ" },
      { key: "බන්ධන වියෝජන එන්තැල්පිය", val: "බන්ධනයක් කැඩීමට ශක්තිය සැපයිය යුතු බැවින් සෑමවිටම ධන අගයකි (+ΔH)" },
      { key: "පරිවේෂ්ටන එන්තැල්පිය", val: "ලැටිස් ශක්තිය (U) සහ සජලන එන්තැල්පිය (ΔH_hyd) අතර අගයන් මත රඳා පවතී" },
      { key: "ස්වයංසිද්ධ ප්‍රතික්‍රියා", val: "නිදහස් ගිබ්ස් ශක්තිය ΔG = ΔH - TΔS < 0 (සෘණ ලැබීම මඟින් තීරණය වේ)" }
    ]
  },
  {
    category: "GAS LAWS",
    category_si: "වායු නියම",
    title_si: "පරිපූර්ණ වායු නියම හා තාත්වික වායූන්ගේ හැසිරීම",
    items: [
      { key: "පරිපූර්ණ වායු සමීකරණය", val: "PV = nRT වේ (මෙහි R = 8.314 J K⁻¹ mol⁻¹)" },
      { key: "ඩෝල්ටන්ගේ අංශුක පීඩන නියමය", val: "මුළු පීඩනය = සියලු අර්ධ පීඩනවල එකතුවයි (P_total = ΣP_i)" },
      { key: "තාත්වික වායු පරාසය", val: "අඩු පීඩනය සහ ඉතා ඉහළ උෂ්ණත්ව තත්ත්ව යටතේ පරිපූර්ණ වායු සේ හැසිරේ" },
      { key: "වැන්ඩර්වාල්ස් සමීකරණය", val: "(P + an²/V²)(V - nb) = nRT (a අන්තර් අණුක ආකර්ෂණයටද, b පරිමාවටද වේ)" },
      { key: "ග්‍රැහැම්ගේ විසරණ නීතිය", val: "විසරණ ශීඝ්‍රතාව වායුවේ මවුලික ස්කන්ධයේ වර්ගමූලයට ප්‍රතිලෝමව සමානුපාතික වේ 🔄" }
    ]
  }
];
        ...
        <section className="lg:col-span-2 flex flex-col gap-4">
          ...
          <div className="p-4 bg-slate-950/60 border border-white/5 rounded-2xl mt-auto hidden lg:block">
            ...
            <p className="text-[11px] text-slate-400 leading-relaxed mt-2">
              සියලුම බහුවරණ ප්‍රශ්න ජාතික අධ්‍යාපන ආයතනය (NIE) මඟින් නිකුත් කෙරුණු නවතම විෂය නිර්දේශයේ අකාබනික, කාබනික, බන්ධන, සමතුලිතතාවය, චාලක විද්‍යාව, ශක්ති විද්‍යාව හා වායුමය අවස්ථා සම්පත් පොත්වල කරුණුවලට අනුරූප වේ.
            </p>
          </div>
        </section>
                  ...
                  <div className="p-4 rounded-2xl bg-slate-950 border border-white/5 text-left mb-8">
                    ...
                    <p className="text-xs text-slate-300 leading-relaxed">
                      {activeQuiz.stats.correctCount >= activeQuiz.questions.length * 0.8
                        ? "විශිෂ්ටයි! ඔබ සතුව රසායන විද්‍යා විෂය කොටසෙහි අතිශය සාර්ථක සංකල්පීය අවබෝධයක් පවතී. සම්පත් පොත්වල සඳහන් exceptions වලද ඔබ ප්‍රවීණයෙකි."
                        : activeQuiz.stats.correctCount >= activeQuiz.questions.length * 0.5
                        ? "යහපත් මට්ටමකි. කෙසේවෙතත්, ඇතැම් Tricky ප්‍රශ්න සහ සම්පත් පොත්වල ද්‍රාව්‍යතා හා ප්‍රතික්‍රියා රටාවන් තවදුරටත් මතක් කර ගැනීම ඵලදායී වේ."
                        : "තවදුරටත් උත්සාහ කරන්න. අදාළ සම්පත් පොත්වල ඒ ඒ පරිච්ඡේදවල සඳහන් ප්‍රත්‍යක්ෂ වගු සහ අනුපිළිවෙලවල් නිරන්තරයෙන් පරිශීලනය කරන්න."}
                    </p>
                  </div>
